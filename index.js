...
express()
  ...
  .get('/WinLossStatistics/get/top', async (req, res) => await endpoints.getTopWinLossStatistics(client, req, res))
  .get('/WinLossStatistics/get/player', async (req, res) => await endpoints.getPlayerWinLossStatistics(client, req, res))
